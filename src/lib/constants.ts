...
export const CORE_PRESETS: SynthPreset[] = [
  ...
  { id: 'guitar3', name: 'Acoustic Steel', category: 'Guitar', type: 'triangle', octaveOffset: 0, attack: 0.005, decay: 0.4, sustain: 0.2, release: 0.8 },
  { id: 'strings1', name: 'Violin Arco', category: 'Strings', type: 'sawtooth', octaveOffset: 0, attack: 0.15, decay: 0.2, sustain: 0.8, release: 0.4 },
